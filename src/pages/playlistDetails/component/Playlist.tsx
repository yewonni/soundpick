...
export default function Playlist({ isMobile }: PlaylistProps) {
  ...
  return (
    <section className="mt-2">
      ...
      {!isLoading && (!playlistTrackData || playlistTrackData.length === 0) && (
        <p className="text-sm text-center text-[#666] mt-10">
          플레이리스트에 대한 트랙 정보가 없습니다.
        </p>
      )}
      {!isLoading &&
        Array.isArray(playlistTrackData) &&
